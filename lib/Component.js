...
export class Component
{
  ...
  setParent(parent) {
    ...
    document.contains(this.node) && this.componentDidMount()
  }
  ...
  setState(state) {
    ...
    prevState && this.componentDidUpdate(this.props, prevState)
  }
  ...
  destroy(keepNode = false) {
    ...
    for(const type of this.__handlers) {
      this.node[type] = null
    }
  ...
  static defineEvent(type) {
    ...
    Object.defineProperty(this.prototype, name, {
      ...
      set(callback) {
        ...
        else delete this.__handlers.delete(name)
      },
      get() {
...
const options = {
  ...
  onBeforeElChildrenUpdated(fromNode, toNode) {
    if(toNode.hasOwnProperty('__instance') && fromNode.hasOwnProperty('__instance')) {
      for(const type of fromNode.__instance.__handlers) {
        fromNode[type] = null
      }
      for(const type of toNode.__instance.__handlers) {
